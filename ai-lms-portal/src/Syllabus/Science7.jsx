  ...
  const syllabusData = [
    {
      ...
      content: [
        {
          title: "1. Cell Biology and Microorganisms",
          topics: [
            "Cell and Functions, Plant and Animal Cells",
            "Microorganisms Type Harmful Effects",
          ],
        },
        {
          title: "2. Chemistry – Elements, Compounds and Mixtures",
          topics: [
            "Elements Classification, Compound and Mixtures (Types)",
            "Physical and Chemical Changes Separation of Substances",
          ],
        },
        {
          title: "3. Basics of Astronomy",
          topics: [
            "Solar System, Planets, Satellites",
            "Stars and Constellations, Galaxies",
          ],
        },
        {
          title: "4. Basics of Physics",
          topics: ["Motion", "Energy", "Sound"],
        },
        {
          title: "5. Earth Science – Geology and Earth’s Processes",
          topics: [
            "Structure of the Earth, Types & Cycle",
            "Earthquakes and Volcanoes, Weathering and Erosion",
          ],
        },
        {
          title: "6. Genetics and Heredity",
          topics: [
            "Heredity, Variation, Genes and Chromosomes",
            "Mendel’s Laws, Dominant and Recessive Traits",
          ],
        },
      ],
    },
