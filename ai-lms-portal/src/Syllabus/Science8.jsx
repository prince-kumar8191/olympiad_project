      ...
      content: [
        {
          ...
          topics: [
            ...
            "Basics of Genetics",
            "DNA (basic structure and function – conceptual only)",
          ],
        },
        {
          title: "2. Chemistry – Elements, Compounds & Chemical Reactions",
          topics: [
            ...
            "Separation techniques (filtration, distillation, etc.)",
          ],
        },
        {
          title: "3. Astronomy – Solar System, Stars & Galaxies",
          topics: [
            "Solar System (Planets, moons, asteroids, comets)",
            "Sun as a star",
            "Stars & constellations",
            "Galaxies (Milky Way concept)",
            "Phases of Moon",
            "Eclipses (Solar & Lunar – basic understanding)",
            "Space exploration (basic knowledge)",
          ],
        },
        {
          title: "4. Physics – Motion, Forces & Energy",
          topics: [
            "Motion, Force & Pressure",
            "Laws of Motion (basic understanding)",
            "Work, Energy & Power",
            "Simple Machines, Sound & Light (basic concepts)",
          ],
        },
        {
          title: "5. Earth Science – Geology, Weathering & Erosion",
          topics: [
            "Structure of Earth, Rocks & Minerals",
            "Soil formation and types and Weathering",
            "Erosion & deposition",
            "Natural disasters (earthquakes, volcanoes – basics)",
          ],
        },
        {
          title: "6. Environmental Science – Pollution, Conservation & Sustainability",
          topics: [
            ...
            "Biodiversity (intro) and Climate change (basic understanding)",
