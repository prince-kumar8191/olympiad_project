  ...
  const syllabusData = [
    {
      ...
      content: [
        {
          title: "1. Algebra",
          topics: ["Algebraic Expressions", "Simple Equations"],
        },
        {
          title: "2. Data Handling",
          topics: ["Graphs", "Charts"],
        },
        {
          title: "3. Numbers and Operations",
          topics: ["Integers", "Fractions", "Decimals"],
        },
        {
          title: "4. Geometry",
          topics: ["Angles", "Triangles", "Quadrilaterals"],
        },
        {
          title: "5. Ratio and Proportion",
          topics: [],
        },
        {
          title: "6. Basic Concepts of Probability",
          topics: [],
        },
      ],
    },
          ...
          {syllabusData.map((item, index) => (
            ...
            >
              ...
              <div className="px-6 py-6 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
                ...
                <div
                  className={`inline-block bg-gradient-to-r ${item.color} text-white px-5 py-2 rounded-full text-sm font-bold shadow-md`}
                >
                  {item.subject}
                </div>
