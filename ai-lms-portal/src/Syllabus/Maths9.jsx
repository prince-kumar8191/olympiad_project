      ...
      content: [
        {
          ...
          topics: [
            ...
            "Laws of Exponents, Surds and Radicals",
            "Decimal Expansions, HCF, LCM & Operations on Real Numbers",
          ],
        },
        {
          title: "2. Geometry (A) Triangles",
          topics: [
            "Congruence Criteria & Properties of Triangles",
            "Isosceles & Equilateral Triangle Properties",
            "Inequalities in Triangles & Exterior Angle Property",
            "Introduction to Similarity (Basic Idea)",
          ],
        },
        {
          title: "2. Geometry (B) Circles",
          topics: [
            "Basic Terms (Chord, Arc, Tangent, Secant)",
            "Angle Subtended and Perpendicular by Chord",
            "Equal Chords, Arcs and Basic Tangent Properties",
          ],
        },
        {
          title: "2. Geometry (C) Constructions",
          topics: [
        ...
        },
        {
          ...
          topics: [
            ...
            "Trigonometric Identities & Complementary Angles etc.",
          ],
        },
        {
          title: "4. Algebraic Expressions & Equations",
          topics: [
            "Polynomials (Concept, Degree, Types), Algebraic Identities (Advanced Usage)",
            "Factorization Techniques & Linear Equations",
          ],
        },
        {
          title: "5. Quadratic Equations & Polynomials",
          topics: [
            "Quadratic Equations & Factorization Method",
            "Roots, Relationship Between Zeroes and Coefficients",
            "Graphical Understanding",
          ],
        },
        {
          title: "6. Statistics & Probability (A) Statistics",
          topics: [
            "Data Collection & Representation",
            "Mean, Median, Mode and Graphical Representation",
          ],
        },
        {
          title: "6. Statistics & Probability (B) Probability",
          topics: [
