  ...
  const syllabusData = [
    {
      ...
      content: [
        {
          title: "1. Biology – Genetics, Evolution, Human Health & Diseases",
          topics: [
            "Genetics",
            "Mendel’s Laws of Inheritance",
            "Dominance, Incomplete Dominance, Codominance",
            "Sex Determination (Human)",
            "Basic Structure of DNA & Genes",
            "Evolution",
            "Theories of Evolution",
            "Natural Selection (Concept by Charles Darwin)",
            "Fossils and Evolutionary Evidence",
            "Speciation (Basic Understanding)",
            "Human Health & Diseases",
            "Types of Diseases (Infectious & Non-Infectious)",
            "Pathogens (Bacteria, Virus, Fungi, Protozoa)",
            "Immunity & Vaccines",
            "Common Diseases (Malaria, Dengue, Tuberculosis)",
            "Public Health & Hygiene",
          ],
        },
        {
          title: "2. Chemistry – Chemical Kinetics, Organic & Environmental Chemistry",
          topics: [
            "Chemical Kinetics (Intro Level)",
            "Rate of Reaction",
            ...
            "Functional Groups (Alcohol, Carboxylic Acid, etc.)",
            "Homologous Series",
            "Basic Reactions (Combustion, Oxidation, Substitution)",
        ...
        {
          title: "3. Astronomy – Celestial Mechanics & Cosmology",
          topics: [
            "Celestial Mechanics",
            "Motion of Planets (Kepler’s Laws – Basic)",
            "Gravity and Orbits",
            "Satellites (Natural & Artificial)",
            "Cosmology",
            "Origin of the Universe (Big Bang Theory)",
            "Structure of the Universe",
            "Galaxies, Nebulae, Black Holes (Intro Level)",
            "Expansion of the Universe",
          ],
        },
        {
          title: "4. Physics – Optics, Electromagnetism & Modern Physics",
          topics: [
            "Optics",
        ...
        {
          title: "5. Earth Science – Natural Resources & Conservation",
          topics: [
            "Types of Natural Resources",
            "Renewable & Non-Renewable",
            "Forests, Water, Minerals & Energy Resources",
        ...
        {
          title: "6. Environmental Science – Biodiversity & Climate Change",
          topics: [
            "Biodiversity",
            "Levels of Biodiversity",
            "Importance and Conservation and Endangered Species",
            "Climate Change",
            "Causes (Greenhouse Gases) and Global Warming Impacts",
            "Carbon Footprint and International Efforts",
            "Sustainability",
            "Reduce, Reuse, Recycle (3Rs)",
            "Sustainable Development Goals (Basic Awareness)",
          ],
        },
      ],
    },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-600 via-green-600 to-teal-500">
      ...
      <div className="py-12 px-4 md:px-8">
        ...
        <div className="hidden md:grid max-w-6xl mx-auto grid-cols-10 bg-white/20 backdrop-blur-md text-white font-bold rounded-t-2xl overflow-hidden shadow-lg">
          <div className="col-span-3 px-6 py-4 border-r border-white/20">Subject</div>
          <div className="col-span-7 px-6 py-4">Content</div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          {syllabusData.map((item, index) => (
            <div key={index}>
              <div className="bg-white/90 backdrop-blur-md shadow-2xl md:grid md:grid-cols-10 border border-white/30 overflow-hidden rounded-2xl mb-6">
                {/* SUBJECT */}
                <div className="md:col-span-3 px-6 py-5 border-b md:border-b-0 md:border-r border-gray-200 flex flex-col justify-center">
                  ...
                  <div className={`inline-block bg-gradient-to-r ${item.color} text-white px-4 py-2 rounded-full text-sm font-bold shadow-md w-fit`}>
                    {item.subject}
                  </div>
                ...
                {/* CONTENT */}
                <div className="md:col-span-7 px-6 py-5">
