...
const payNow = async (studentId) => {
  ...
  try {
    // 🔥 IMPORTANT: ₹500 use kar (₹1 mat use kar)
    ...
    const options = {
      key: "rzp_test_SXSRaYXP2vwXGu", // SAME as backend
      amount: order.amount,
      currency: "INR",
      order_id: order.id,
    ...
    wallet: true,
      ...
      prefill: {
        ...
        contact: formData.student_phone,
      },
    ...
    // ❌ FAIL HANDLER (IMPORTANT DEBUG)
    rzp.on("payment.failed", async function (response) {
      console.log("FAILED FULL:", response);
