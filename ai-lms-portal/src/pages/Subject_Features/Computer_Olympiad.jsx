...
import { FaLaptopCode, FaBrain, FaChartLine, FaTrophy, FaCode, FaDesktop } from "react-icons/fa";
import logo from "../../assets/logo.png";
import { useNavigate } from "react-router-dom";

export default function ComputerOlympiad() {
    ...
    <>
            ...
            <div className="relative">
              ...
              {showAwards && (
                <div className="absolute top-10 left-0 bg-white dark:bg-gray-800 shadow-lg rounded-lg p-3 w-48 z-50">
                  ...
                  >
                    Student Recognition Awards and
                  </button>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-gray-700 mb-6">
              The Computer Olympiad helps students develop strong logical
              thinking, programming knowledge, and computer fundamentals.
              It introduces students to the world of coding, algorithms,
              and digital technologies.
            </p>

            <Link to="/computer-mocktest">
      ...
      <div className="py-16 bg-white">
        ...
        <h2 className="text-4xl font-bold text-center text-indigo-600 mb-12">
          Why Participate in Computer Olympiad?
        </h2>

        <div className="grid md:grid-cols-4 gap-8 max-w-6xl mx-auto px-6">

          <div className="text-center p-6 shadow-lg rounded-2xl hover:scale-105 transition">
            <FaCode size={40} className="mx-auto text-indigo-600 mb-4" />
            <h3 className="font-bold text-lg">Coding Skills</h3>
            <p className="text-gray-600 mt-2">
              Learn basic programming and coding logic.
            </p>
          </div>
          ...
          <div className="text-center p-6 shadow-lg rounded-2xl hover:scale-105 transition">
            ...
            <p className="text-gray-600 mt-2">
              Improve algorithmic and problem solving ability.
            </p>
          </div>

          <div className="text-center p-6 shadow-lg rounded-2xl hover:scale-105 transition">
            <FaDesktop size={40} className="mx-auto text-indigo-600 mb-4" />
            <h3 className="font-bold text-lg">Computer Knowledge</h3>
            <p className="text-gray-600 mt-2">
              Learn computer fundamentals and digital skills.
            </p>
          </div>
          ...
          <div className="text-center p-6 shadow-lg rounded-2xl hover:scale-105 transition">
            ...
            <p className="text-gray-600 mt-2">
              Prepare for national level computer competitions.
            </p>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto px-6">
          ...
          <div className="bg-white p-8 rounded-2xl shadow text-center hover:scale-105 transition">
            ...
            <p className="text-gray-600">
              Practice computer Olympiad style questions.
            </p>
          </div>
