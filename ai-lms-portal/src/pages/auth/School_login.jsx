...
const handleSubmit = async (e) => {
  ...
  try {
    const res = await axios.post(`${import.meta.env.VITE_API_URL}/school-login`, form);
    ...
    localStorage.setItem("school_email", res.data.data.email);
localStorage.setItem("school_code", res.data.data.school_code);
